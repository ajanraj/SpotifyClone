    ...
    (function() {
      ...
      $vol_thumb.draggable({
        ...
        drag: function() {
          ...
          $vol_bar.attr(
            "data-value",
            parseInt((posX / $vol_parent.width()) * 100)
          );
      ...
      $dur_main.click(function(e) {
        ...
        $musicPlayer.currentTime =
          (posX / $dur_parent.width()) * $musicPlayer.duration;
      });
      // Updates range bar and time (MM : SS) in DOM when playing
      $musicPlayer.ontimeupdate = function() {
        $("#startTime").text(
          getDurMin(this.currentTime).min +
            " : " +
            getDurMin(this.currentTime).sec
        );
      ...
      $dur_thumb.draggable({
        ...
        drag: function() {
          ...
          calcDur =
            ($dur_bar.width() / $dur_parent.width()) * $musicPlayer.duration;
          $("#startTime").text(
            getDurMin(calcDur).min + " : " + getDurMin(calcDur).sec
          );
        },
        stop: function() {
