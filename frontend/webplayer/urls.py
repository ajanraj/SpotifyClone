...
urlpatterns = [
    ...
    path('artist/songs/<int:sid>/<int:aid>',
         views.artist_details, name='player-artist-details'),

    path('mood/<int:sid>/', views.mood, name='player-mood'),
    path('mood/songs/<int:sid>/<int:mid>',
         views.mood_details, name='player-mood-details'),
